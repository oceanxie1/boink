        ...
        <Box padding="30px" overflow="auto" height="100%">
          ...
          <Box>
            {cart.map((item) => {
              ...
              const itemShortDescription = extractText(item.attributes.shortDescription);
              const itemCount = item.count;
              const itemPrice = item.attributes.price;

              return (
                <Box key={`${itemName}-${item.id}`}>
                  <FlexBox p="15px 0">
                    <Box flex="1 1 40%">
                    ...
                    <Box flex="1 1 60%">
                      ...
                      <Typography>{itemShortDescription}</Typography>
                      <FlexBox m="15px 0">
                        <Box
                          display="flex"
                          alignItems="center"
                        ...
                        <Typography fontWeight="bold">${itemPrice}</Typography>
                      </FlexBox>
                    </Box>
                  </FlexBox>
                  <Divider />
